...
//
//type server struct {
//	handler.UnimplementedChatbotServiceServer
//	db  *sql.DB
//	rdb *redis.Client
//}
//
//func (s *server) Register(ctx context.Context, req *handler.RegisterRequest) (*handler.ReportResponse, error) {
//
...
//}
//
//func (s *server) Login(ctx context.Context, req *handler.LoginRequest) (*handler.ReportResponse, error) {
//	username := req.GetUsername()
//	password := req.GetPassword()
//
...
//}
//
//func (s *server) ShowUserList(ctx context.Context, req *handler.Empty) (*handler.UserListResponse, error) {
...
//	}
//
//	return &handler.UserListResponse{
//		UserList: userList,
//		Status:   statusList,
//	}, nil
//}
//
//func (s *server) SendMessage(ctx context.Context, req *handler.SendMessageRequest) (*handler.ReportResponse, error) {
...
//	if err != nil {
//		return &handler.ReportResponse{Message: "Unauthorized: Invalid or expired session", Success: false}, nil
//	}
//
...
//}
//
//func (s *server) Logout(ctx context.Context, req *handler.LogoutRequest) (*handler.ReportResponse, error) {
...
//}
//
//func (s *server) ShowMessage(ctx context.Context, req *handler.ShowMessagesRequest) (*handler.ShowMessagesResponse, error) {
//	count := req.GetCount()
//	sessionToken := req.GetId()
...
//	userId, err := s.rdb.Get(ctx, sessionToken).Result()
//	if err != nil {
//		return &handler.ShowMessagesResponse{
